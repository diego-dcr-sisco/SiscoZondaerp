...
function displaySelectedServicestoContract() {
    ...
    if (selected_services.length > 0) {
        ...
        let totalCost = 0;
        let totalOrders = 0;
        //console.log("Services Configuration:", selected_services);
        ...
        selected_services.forEach((service) => {
            ...
            console.log("Configurations:", contract_configurations);
            /*contract_configurations = contract_configurations.concat(
                configurations || [],
            );*/
            ...
            //console.log("Service Configurations for Service ID " + service.id, c_configs);
...
function displaySelectedServicestoOrder() {
    ...
    console.log("Displaying services for order view");
...
// Función para contar órdenes por estado (nueva función)
...
// Función para obtener el resumen de órdenes por servicio (nueva función)
