...
function updateOrder() {
    ...
    // Validar tamaño de la firma si existe
    if (order.signature_base64 && order.signature_base64.length > 0) {
    ...
    console.log('Enviando orden con firma de tamaño:', order.signature_base64 ? Math.round(order.signature_base64.length / 1024) + 'KB' : 'Sin firma');
