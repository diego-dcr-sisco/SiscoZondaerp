<div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
        <form class="modal-content border-0 shadow-sm needs-validation" action="{{ route('warehouse.store') }}"
            method="POST" id="warehouseForm" novalidate>
            @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="warehouse_name" name="name"
                                    value="{{ old('name') }}" required minlength="3" maxlength="255"
                                    placeholder="Ej: Almacén Central Norte" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control" id="observations_textarea" name="observations" rows="4" maxlength="1000"
