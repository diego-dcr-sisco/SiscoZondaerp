    ...
    <div class="border rounded shadow p-3 mb-3">
        <div class="row">
            ...
            <div class="col-12 mb-3">
                ...
                <div class="smnote" id="summary-describe" style="height: 250px">
                </div>
...
<script>
    $(document).ready(function() {
        ...
        window.setServiceDescriptionHtml = function(html) {
            serviceDescriptionEditor.clipboard.dangerouslyPasteHTML(html || '');
            syncServiceDescription();
        };
    });
    ...
    function set_instructions() {
        ...
        window.setServiceDescriptionHtml(description);
    }
</script>
