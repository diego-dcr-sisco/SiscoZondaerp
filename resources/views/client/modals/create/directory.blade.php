 <div class="modal fade" id="directoryModal" tabindex="-1" aria-labelledby="directoryModalLabel" aria-hidden="true">
     <div class="modal-dialog">
         <form class="modal-content" method="POST" id="directoryForm"
 ...
 <script>
     $(document).ready(function() {
         ...
         $('#directoryForm').on('submit', function(e) {
             ...
             isSubmitting = true;
             $('#btnCreateDir').prop('disabled', true).html('<span class="spinner-border spinner-border-sm me-2"></span>Creando...');
         });
