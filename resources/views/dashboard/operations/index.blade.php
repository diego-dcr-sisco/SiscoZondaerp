    ...
    <div class="container-fluid p-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h2 class="fw-bold mb-0">
                <i class="bi bi-clipboard-check-fill me-2"></i>Control de Operaciones
            </h2>
            <div class="text-end">
                <span class="badge bg-primary fs-6">{{ $orders->total() }} Reportes Pendientes</span>
            </div>
        </div>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-lg-4">
                        <label class="form-label">
                            <i class="bi bi-person-fill me-1"></i>Técnico(s)
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" 
                                        ...
                                        <i class="bi bi-funnel me-2"></i>Seleccionar Técnicos
                                    </button>
                                </h2>
                                <div id="collapseTechnicians" class="accordion-collapse collapse" 
                                    ...
                                    <div class="accordion-body p-0">
                                        ...
                                        <div class="technicians-list" id="technicians-list">
                                            @foreach ($technicians as $technician)
                                                @php
                                                    ...
                                                    $isSelected = in_array((string)$technician->id, (array)$selectedTechnicians);
                                                @endphp
                                                <div class="technician-item d-flex align-items-center {{ $isSelected ? 'checked' : '' }}" 
                                                     data-name="{{ strtolower($technician->name) }}">
                                                    <input type="checkbox" 
                                                           class="form-check-input technician-checkbox" 
                                                           name="technician_ids[]" 
                                                           value="{{ $technician->id }}"
                                        ...
                                        <div class="technician-actions p-3 border-top">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary btn-sm" onclick="clearAllTechnicians()">
                    ...
                    <div class="col-lg-2">
                        <label for="start_date" class="form-label">
                            <i class="bi bi-calendar-fill me-1"></i>Fecha Inicio
                        </label>
                    ...
                    <div class="col-lg-2">
                        <label for="end_date" class="form-label">
                            <i class="bi bi-calendar-fill me-1"></i>Fecha Fin
                        </label>
                    ...
                    <div class="col-lg-12 d-flex justify-content-end m-0 mt-3">
                        ...
                        <a href="{{ route('operations.index') }}" class="btn btn-secondary btn-sm">
                ...
                <tbody>
                    ...
                    @forelse ($orders as $index => $order)
                        ...
                        <tr>
                            ...
                            <!-- Cliente -->
                            <td>
                                <span class="fw-bold text-decoration-underline">{{ $order->customer->name ?? 'Sin cliente' }}</span>
                                @if($order->customer && $order->customer->type == 2)
                                    <br><small class="text-muted">Sede de: {{ $order->customer->matrix->name ?? '-' }}</small>
                                @endif
                            </td>
