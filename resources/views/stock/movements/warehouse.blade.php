...
@section('content')
    ...
    <div class="container-fluid p-0">
            <div class="m-3">
                <form action="{{ isset($warehouse) ? route('stock.movements.warehouse', ['id' => $warehouse->id]) : route('stock.movements.all') }}" method="GET" class="mb-3">
                    <div class="card">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="warehouse-summary-card">
                            <div class="d-flex justify-content-between align-items-start gap-3">
                                <div>
                                    <div class="warehouse-summary-label">Almacén</div>
                    ...
                    <table class="table table-sm table-bordered table-striped caption-top">
                        ...
                        <tbody>
                            @forelse ($movements as $index => $movement)
                                @php
                                    $movementProducts = $movement->products()->where('warehouse_id', $warehouse->id)->get();
