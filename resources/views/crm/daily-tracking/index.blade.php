...
@section('content')
    ...
    <div class="container-fluid font-small p-3">
            ...
            <div class="alert alert-info border mb-3">
                <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                    <div>
                        ...
                        <small class="text-muted">Los prospectos se guardan en la tabla de prospectos comerciales y no
                            aparecen en esta tabla de actividades diarias.</small>
                    </div>
                    ...
                    <div class="modal-dialog modal-xl modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="skippedRowsImportModalLabel">Filas no insertadas en
                                    importación</h5>
        ...
        <div style="overflow-x: auto; width: 100%;">
            <table class="table table-bordered table-sm">
                <caption class="caption-top bg-white p-3 border rounded mb-0">
                    {{-- CORRECCIÓN: eliminado @csrf en form GET --}}
                    <form method="GET" action="{{ route('crm.daily-tracking.index') }}">
                        <div class="row g-2 mb-2">
                            <div class="col-lg-2">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="customer" class="form-control form-control-sm"
                                        value="{{ request('customer') }}" placeholder="Buscar por nombre..." />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <select name="is_recurrent" class="form-select form-select-sm">
                                        <option value="">Todos</option>
                                        <option value="1" @selected(request('is_recurrent') === '1')>Si</option>
                                        <option value="0" @selected(request('is_recurrent') === '0')>No</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <select name="sort" class="form-select form-select-sm">
                                        <option value="created_at" @selected(request('sort', 'created_at') === 'created_at')>Creacion</option>
                                        <option value="service_date" @selected(request('sort') === 'service_date')>Fecha</option>
                                        <option value="customer_name" @selected(request('sort') === 'customer_name')>Cliente</option>
                            ...
                            <div class="col-lg-2">
                                ...
                                {{-- CORRECCIÓN: eliminados ids duplicados "basic-addon1" --}}
                                <div class="input-group input-group-sm">
                            ...
                            <td class="py-2 px-2">
                                <div class="d-flex gap-1 align-items-center justify-content-center flex-wrap">
                                    ...
                                    <a href="{{ route('crm.daily-tracking.edit', $item) }}"
                                        class="btn btn-secondary btn-sm px-2" data-bs-toggle="tooltip"
                                    ...
                                    {{-- CORRECCIÓN: form de delete con type="button" explícito en tooltip --}}
                                    <form action="{{ route('crm.daily-tracking.destroy', $item) }}" method="POST"
        ...
        {{-- Modal: Crear registro diario --}}
        <div class="modal fade" id="createDailyTrackingModal" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="createDailyTrackingModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="createDailyTrackingModalLabel">Nuevo registro de actividad
                            diaria</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <form id="createDailyTrackingForm" action="{{ route('crm.daily-tracking.store') }}"
                        method="POST">
                        @csrf
                        ...
                        <div class="modal-footer d-flex justify-content-between">
                            <button type="button" class="btn btn-info" onclick="autoFillDailyTrackingForm()">
        ...
        <div class="modal fade" id="exportDailyTrackingModal" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="exportDailyTrackingModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exportDailyTrackingModalLabel">Exportar reporte Excel</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <select name="group_by" class="form-select form-select-sm" required>
        ...
        {{-- Modal: Importar CSV --}}
        <div class="modal fade" id="importDailyTrackingModal" data-bs-backdrop="static" data-bs-keyboard="false"
            tabindex="-1" aria-labelledby="importDailyTrackingModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="upload-zone border-2 border-dashed border-primary rounded p-4 text-center"
                                    ...
                                    <input type="file" name="excel_file" id="excelFileInput" class="d-none"
                                        accept=".csv,text/csv" required>
                                </div>
                                <div class="mt-2 d-none" id="fileName">
                            ...
                            <div id="importLoadingState" class="d-none border rounded p-3 bg-light">
                                ...
                                <small class="text-muted d-block mt-2">Esto puede tardar unos segundos dependiendo
                                    del tamaño del archivo.</small>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                                id="importCancelBtn">Cancelar</button>
        ...
        {{-- Modal: Crear Cliente desde registro diario (versión única y correcta) --}}
        <div class="modal fade" id="createCustomerFromTrackingModal" data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-labelledby="createCustomerFromTrackingModalLabel"
            aria-hidden="true">
                    ...
                    <form id="createCustomerFromTrackingForm" method="POST" action="">
                        ...
                        <div class="modal-body">
                            <div class="alert alert-info small mb-3">
                                <i class="bi bi-info-circle"></i>
                                Los datos se precargaron del registro seleccionado. Revisa y completa los campos
                            ...
                            <div class="row g-3">
                                ...
                                {{-- CORRECCIÓN: service_type_id como variable JS directa, eliminado span data-map --}}
    ...
    <script>
        ...
        if (uploadZone) {
            ...
            function handleFileSelected() {
                if (excelFileInput.files.length > 0) {
                    ...
                    if (excelFileError) excelFileError.classList.add('d-none')
        ...
        if (importForm) {
            importForm.addEventListener('submit', function(e) {
                if (!excelFileInput || !excelFileInput.files || excelFileInput.files.length === 0) {
                    e.preventDefault()
                    if (excelFileError) excelFileError.classList.remove('d-none')
                    if (importBtn) importBtn.disabled = true
                    return
                }
                if (importLoadingState) importLoadingState.classList.remove('d-none')
                if (uploadZone) {
                ...
                if (importCancelBtn) importCancelBtn.disabled = true
            })
        }
        ...
        function autoFillDailyTrackingForm() {
            ...
            setFieldValue('state', 'SLP')
            setFieldValue('city', 'San Luis Potosi')
        ...
        ;(function() {
            const ctfCitiesData = {!! json_encode($cities, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE) !!};
            const ctfStatesData = {!! json_encode($states, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE) !!};

            {{-- CORRECCIÓN: serviceTypeMap como variable JS directa, eliminado span con data-map --}}
            const ctfServiceTypeMap = {!! json_encode(
                $customerServiceTypes->map(fn($st) => ['id' => $st->id, 'name' => strtolower($st->name)])->values()->all(),
            ...
            document.querySelectorAll('.btn-create-customer').forEach(function(btn) {
                btn.addEventListener('click', function() {
                    ...
                    document.getElementById('ctf_service_type_id').value = resolveServiceTypeId(customerType)
