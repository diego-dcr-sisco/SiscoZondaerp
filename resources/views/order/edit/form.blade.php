                ...
                <table class="table table-bordered table-hover table-sm">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-primary fw-bold">{{ isset($order->customer) ? ($order->customer->name ?? '-') : '-' }}</td>
                        </tr>
                        <tr>
                            <td class="fw-bold">Código:</td>
                            <td>
                                {{ isset($order->customer) ? ($order->customer->code ?? '-') : '-' }}
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bold">ID:</td>
                            <td>
                                {{ isset($order->customer) ? ($order->customer->id ?? '-') : '-' }}
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bold">Dirección:</td>
                            <td class="text-muted">{{ isset($order->customer) ? ($order->customer->address ?? '-') : '-' }}</td>
                        </tr>
                        <tr>
                            <td class="fw-bold">Tipo:</td>
                            <td>{{ isset($order->customer) && isset($order->customer->serviceType) ? ($order->customer->serviceType->name ?? '-') : '-' }}</td>
                        </tr>
                    </tbody>
                    <tfoot>
                    </tfoot>
