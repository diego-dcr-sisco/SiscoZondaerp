    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            font-size: 6px;
            /* Tamaño base pequeño para que quepan 12 meses */
            color: #000;
            /* Color de texto gris oscuro */
            background: white;
            padding: 5mm;
            /* Espaciado interno del documento */
        }

        /* Configuración de la página para PDF */
        @page {
            size: A4 portrait;
            /* Página horizontal para aprovechar el ancho */
            margin: 8mm;
        ...
        .months-container {
            width: 100%;
            clear: both;
            /* Limpia cualquier float anterior */
        }

        /* Cada bloque de mes - float left para posicionamiento horizontal */
        .month-block {
            float: left;
            /* Posiciona los meses lado a lado */
            width: 32%;
            /* Ancho de cada mes (4 columnas: 24% x 4 + 1% x 3 gaps = 99%) */
            margin-right: 2%;
            /* Espacio entre calendarios */
            margin-bottom: 1.5mm;
            /* Espacio vertical entre filas */
            page-break-inside: avoid;
            /* Evita que un mes se divida entre páginas */
        }
        ...
        /* ============================================
           ESTILOS DEL CALENDARIO
            ...
            --deep-sky-blue: #178EBFff;
            --platinum: #B1B1B1ff;
            --azure-blue: #2064BFff;
            --neon-chartreuse: #B1BF23ff;
            --lime-moss: #767C13ff;
           ============================================ */
